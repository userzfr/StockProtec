          ...
          <div className="flex items-center gap-3">
            ...
            {onScanClick && (
              <Button
                onClick={onScanClick}
                variant="outline"
                className="bg-green-500/20 border-green-300/30 text-white hover:bg-green-500/30 hover:text-white backdrop-blur-sm"
              >
            ...
            {currentUser.role === 'admin' && (
              <Button
                onClick={onOpenAdmin}
                variant="outline"
                className="bg-white/10 border-white/20 text-white hover:bg-white/20 hover:text-white backdrop-blur-sm relative"
              >
            ...
            <Button
              onClick={onLogout}
              variant="outline"
              className="bg-red-500/20 border-red-300/30 text-white hover:bg-red-500/30 hover:text-white backdrop-blur-sm"
            >
